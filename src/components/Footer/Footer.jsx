  ...
  return (
    <div className={cx("relative flex h-[437px] w-full x")}>
      ...
      <div className="relative pt-[320px] w-full h-auto ">
        <div className="py-[40px] px-[60px] mx-auto">
          <div className="flex justify-between items-start">
            ...
            <div className="w-[725px] flex justify-between">
              ...
              <div className="w-auto ml-[100px]">
                <h1 className="mb-[32px] uppercase font-medium">Opening hours</h1>
                <ul className="">
              ...
              <div className="w-auto">
                ...
                <ul className="">
                  <li className="mt-[2px] text-[14px]">Home</li>
                  <li className="mt-[2px] text-[14px]">Praxis Leandra Isler</li>
          ...
          <div className="flex justify-between items-center">
            <div className="text-[14px] uppercase font-medium">Made by ESE Agency</div>
            <div className="flex gap-4">
              <span className="uppercase font-medium text-[14px]"> imprint and Data protection</span>
