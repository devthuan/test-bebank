          ...
          <div className="px-[30px] md:px-16 lg:px-16">
            <ScrollReveal>
              <h1 className="text-[24px] md:text-[36px] lg:text-[66px] tracking-[-1px] md:tracking-[-3px] m-[-10px]">
                Back to the roots — this guiding principle accompanies me
                through my world like a common thread.
              </h1>
            </ScrollReveal>
            <ScrollReveal delay={300}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px] md:gap-[60px] mt-[20px] md:mt-[58px]">
                <p className="text-[14px] md:text-[16px] lg:text-[18px]">
                  ...
                  therapies in the field of conventional and complementary
                  medicine, I was able to leave the disease behind me after 7
                  years. A short time later, the desire to research the origin
                  ever greater so that I could also heal the effects that were
                  still being felt. I set off back to my roots and learned so
                  much
                </p>
                <p className="text-[14px] md:text-[16px] lg:text-[18px]">
                  valuable during this time, which brought the value of my
                  medical history to a whole new level. I would like to share
                  the experiences that have shaped, shaped and advanced me,
                  together with the knowledge from my training courses, and hope
                  to be able to do at least as much good as I was able to
                  experience.
                </p>
              </div>
            </ScrollReveal>
